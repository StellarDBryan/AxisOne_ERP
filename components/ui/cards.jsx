...
export function ActiveCard({ active }){
    ...
    return(
        <>
            <div className="card flex flex-row items-center justify-around gap-5 md:gap-5 w-full h-[150px] sm:w-[265px] sm:h-[150px] md:w-[310px] md:h-[175px] lg:w-[425px] lg:h-[160px] bg-neutral-600 rounded-md drop-shadow-lg transition-all duration-200 ease-in-out">
                {active.image 
                    ? <Image 
                        src={active.image}
                    ...
                    : <Image 
                        ...
                        height={100}
                        className="rounded-l-md object-contain p-3 w-[80px] h-full sm:w-[80px] md:w-[90px] lg:w-[110px] bg-gray-200" />}
                <div className="flex flex-col w-full pr-5 text-gray-50 gap-1 items-start overflow-hidden">
                    <span className="text-[0.9rem] truncate sm:text-sm1 md:text-p lg:text-[1.1rem] text-cyan-200 font-extrabold">{active.active}</span> 
                    ...
                    <button className="btn absolute ring-2 ring-neutral-500 bottom-3 sm:bottom-16 md:bottom-3 lg:bottom-3 right-4 md:right-3 lg:right-4 btn-circle border-none bg-neutral-700/70 hover:bg-neutral-800/80 text-gray-50 flex items-center justify-center">
